...
Create the `review-checklist.md` artifact for the fixed workflow. If `idea.md`, `spec.md`, or `tasks.md` exists, use those artifacts as the source of truth. Focus the checklist on product clarity, engineering clarity, testing, testability, and scope control.
...
- Keep checks specific enough for a reviewer to answer yes or no.
- Include scope-control checks that catch accidental product expansion.
- Do not require an LLM, hosted service, or manual model response to complete the checklist.
